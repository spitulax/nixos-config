...
map("n", "(", "zh", { desc = "Scroll to left" })
map("n", ")", "zl", { desc = "Scroll to right" })
map("n", "H", "zH", { desc = "Half screen to left" })
map("n", "L", "zL", { desc = "Half screen to right" })
map("n", "<A-<>", "gg", { desc = "Move to beginning of buffer" })
map("n", "<A->>", "G", { desc = "Move to end of buffer" })
